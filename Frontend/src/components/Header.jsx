            ...
            <div className='div-header'>
                ...
                <div className="user-section">
                    <div className="user-info">
                        <p className="mb-0 text-white d-none d-sm-block"> <strong>{user?.nombre} {user?.apellido}</strong></p>
                        <Link to={"/perfil"}>
                            <img src={userImg} alt="user" width="35" />
                        </Link>
                    </div>

                    <img src={logoutImg} alt="logout" width="30" onClick={signOut} style={{cursor: 'pointer'}} />
                </div>
            </div>
        </header>
    );
