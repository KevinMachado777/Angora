...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                .cors(cors -> cors.configurationSource(corsConfigurationSource())) // ✅ solo una vez
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    http.requestMatchers(HttpMethod.OPTIONS, "/**").permitAll(); // para preflight
                    http.requestMatchers(HttpMethod.POST, "/ordenes/**").permitAll();

                    http.anyRequest().authenticated(); // ✅ al final
                })
                .build();
    }
